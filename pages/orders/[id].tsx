...
const OrderPage: NextPage = () => {
   ...
   return (
    <ShopLayout title='Resumen de la orden 1242424' description='Resumen de la orden'>
    <Typography variant='h1' component='h1' marginBottom={2}>Orden: ABC1234</Typography>
